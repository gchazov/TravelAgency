...
namespace TravelAgency.Queries
{
    public partial class FlightTimeForm : Form
    {
        ...
        private void pdf_Click(object sender, EventArgs e)
        {
            ...
            sfd.FileName = "Время в полете PDF-отчет от " + DateTime.Now.ToString("dd-MM-yyyy HH-mm");
        ...
        private void excel_Click(object sender, EventArgs e)
        {
            ...
            sfd.FileName = "Время в полете Excel-отчет от " + DateTime.Now.ToString("dd-MM-yyyy HH-mm");
            if (sfd.ShowDialog() == DialogResult.OK)
            {
        ...
        private void FlightTimeForm_FormClosing(object sender, FormClosingEventArgs e)
        {
